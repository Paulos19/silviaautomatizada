    ...
    <div className="relative min-h-screen flex items-center justify-center bg-[#050C14] overflow-hidden p-4">
      ...
      <div className="relative z-10 w-full max-w-[420px] bg-[#0B121D]/60 backdrop-blur-2xl border flex flex-col items-center border-teal-500/30 rounded-[35px] px-8 py-10 shadow-[0_0_50px_rgba(20,184,166,0.15)] overflow-hidden">
        ...
        <div className="text-center mb-8">
          <h1 className="text-xl font-outfit text-white font-bold tracking-widest uppercase">Bem-vinda de Volta</h1>
          <p className="text-sm text-slate-400 font-inter mt-2">Acesso Seguro ao Portal Médica</p>
        </div>
        ...
        <div className="w-full flex items-center justify-center gap-4 my-8 relative">
          ...
          <span className="text-xs text-slate-500 font-inter">Ou entre com:</span>
        ...
        {/* Footer Link */}
        <Link href="/register" className="text-xs text-teal-500 font-inter hover:text-teal-400 hover:underline underline-offset-4 transition-all">
          Criar nova conta?
        </Link>
      </div>
    </div>

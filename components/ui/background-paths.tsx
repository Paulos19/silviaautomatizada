...
export function BackgroundPaths({
    title = "Fale com a Silvia",
    subtitle = "Pronta para orquestrar sua clínica 24 horas por dia.",
}: {
    title?: string;
    subtitle?: string;
}) {
    ...
    return (
        <div className="relative min-h-[80vh] w-full flex items-center justify-center overflow-hidden bg-white dark:bg-[#09090B]">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
                ...
                >
                    ...
                    <motion.p
                        ...
                        className="text-lg md:text-xl text-neutral-500 dark:text-neutral-400 mb-10 font-inter max-w-2xl mx-auto"
                    >
                        {subtitle}
                    </motion.p>
